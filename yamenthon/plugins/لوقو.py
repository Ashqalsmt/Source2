...
async def lg1(userevent):
    ...
    if gvarstatus("REP_FONTS") is None: # code by t.me/T_A_Tl
    ...
    if arabic_text: # code by t.me/T_A_Tl
...
async def lg1(userevent):
    ...
    if not arabic_text: # code by t.me/T_A_Tl
