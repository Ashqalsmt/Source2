...
حقـوق للتـاريخ : @YamenThon
@T_A_Tl - كتـابـة الملـف :  الاسطوره عاشق الصمت"""
#الاسطوره عاشق الصمت يولـد هههههههههههههههههههههههههه
import asyncio
import math
import os
...
BaqirVP_cmd = (
    "𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/YamenThon) 𓆪\n\n"
    ...
    "⪼ قنـاة كلايـش الفحـص @YamenThon_vars\n\n"
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد ع الكليشـه مـن القنـاة @YamenThon_vars\n\n\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @YamenThon_vars\n\n"
...
BaqirTZ_cmd = (
    "𓆩 [𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامـر الوقت](t.me/YamenThon) 𓆪\n\n"
...
@zq_lo.rep_cmd(pattern=r"اضف فار (.*)")
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if gvarstatus("ALIVE_NAME") is not None:
            await rep.edit("**「❖╎تم تغييـر {} بنجـاح ☑️**\n**「❖╎المتغيـر : ↶**\n `{}` \n**「❖╎يتم الان اعـادة تشغيـل بـوت يـــمنثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        else:
            await rep.edit("**「❖╎تم اضافـة {} بنجـاح ☑️** \n**「❖╎المضاف اليه :**\n `{}` \n**「❖╎يتم الان اعـادة تشغيـل بـوت يـــمنثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        addgvar(variable, vinfo)
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await rep.edit("**「❖╎تم حـذف {} بنجـاح ☑️**\n**「❖╎المتغيـر المحـذوف : ↶**\n `{}` \n**「❖╎يتم الان اعـادة تشغيـل بـوت يـــمنثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, variable))
        ...
        if variable is None:
        	return await rep.edit("**「❖╎عـذࢪاً عـزيـزي .. انت لـم تقـم باضـافـة فـار {} اصـلاً...**".format(input_str))
        await rep.edit("**「❖╎تم حـذف {} بنجـاح ☑️**\n**「❖╎المتغيـر المحـذوف : ↶**\n `{}` \n**「❖╎يتم الان اعـادة تشغيـل بـوت يـــمنثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, heroku_var[variable]))
        delgvar(variable)
    elif input_str == "رسائل الحماية" or input_str == "رسائل الحمايه" or input_str == "رسائل الخاص" or input_str == "رسائل حماية الخاص" or input_str == "عدد التحذيرات":
        variable = "MAX_FLOOD_IN_PMS"
        await asyncio.sleep(1.5)
...
# Copyright (C) 2022 RepthonArabic . All Rights Reserved
@zq_lo.rep_cmd(pattern="جلب فار(?:\\s|$)([\\s\\S]*)")
...
async def variable(event):
    ...
    rep = await edit_or_reply(event, "**「❖╎جـاري أعـداد المنطقـه الزمنيـه لـ يـــمنثون 🌐...**")
    # All Rights Reserved for "Repthon" "باقر"
    if input_str == "العراق" or input_str == "اليمن" or input_str == "سوريا" or input_str == "السعودية" or input_str == "لبنان" or input_str == "الاردن":
        ...
        if gvarstatus("TZ") is not None:
            await rep.edit("**「❖╎تم تغييـر المنطقـه الزمنيـه .. بنجـاح ☑️**\n**「❖╎المتغير : ↶**\n دولـة `{}` \n**「❖╎يتم الان اعـادة تشغيـل بـوت يـــمنثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str))
        else:
    ...
    if tiba.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await rep.edit("**「❖╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**「❖╎المتغيـر : ↶**\n `{}` \n\n**「❖╎قنـاة السـورس : @YamenThon**".format(input_str, vinfo))
