...
#Code by T.me/T_A_Tl
rep_dev = (6669024587,6937025378)
rep_dev = (6669024587,6937025378)
baqir = (5571722913, 5571722913)
...
# Copyright (C) 2021 yamenthon . All Rights Reserved
# الـرتب الوهميـه & فارات الكليشـه & البريميـوم & عـدد الرسـائل & التفاعـل = كتـابـة الكـود - الاسطوره عاشق الصمت @T_A_Tl / خاصـه بسـورس - يـــمنثون @yamenthon فقـط
    rmsg = await bot.get_messages(event.chat_id, 0, from_user=user_id) #Code by T.me/T_A_Tl
    rrr = rmsg.total
    if rrr < 100: #Code by T.me/T_A_Tl
        baqr = "غير متفاعل  🗿"
        ...
        baqr = "نار وشرر  🏆"
################# Dev yamenthon #################
    if user_id in baqir: #Code by T.me/T_A_Tl
...
################# Dev yamenthon ################# 
    ...
    if baqqir == True or user_id in baqir: #Code by T.me/T_A_Tl
    ...
    if user_id != (await event.client.get_me()).id: #Code by T.me/T_A_Tl
