...
from . import zq_lo, BOTLOG, BOTLOG_CHATID, HEROKU_APP, mention, StartTime, repversion
...
@zq_lo.rep_cmd(pattern="الانترنت(?:\\s|$)([\\s\\S]*)")
async def _(event):
