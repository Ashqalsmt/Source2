                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\n--------بـدء تتبـع سجـل يـــمنثون 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع يـــمنثون 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉--------"
                        ...
                        link = "[𐇮 ℡𓆩✗ ¦ ↱𓄂𝑨𝑺𝑯𝑬𝑸 𝑨𝑳𝑺𝑨𝑴𝑻↲ ¦ ✗𖠚卐𓆪 𐇮](https://t.me/T_A_Tl)"
                        text = (
                            "**✘ تقـريـر اشعـار يـــمنثون 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار يـــمنثون 𝙔𝘼𝙈𝙀𝙉𝙏𝙃𝙊𝙉 ✘**\n\n "
                        link = "[𐇮 ℡𓆩✗ ¦ ↱𓄂𝑨𝑺𝑯𝑬𝑸 𝑨𝑳𝑺𝑨𝑴𝑻↲ ¦ ✗𖠚卐𓆪 𐇮](https://t.me/T_A_Tl)"
